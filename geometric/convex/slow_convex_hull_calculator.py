...
from geometric import Edge, Point
...
class SlowConvexHullCalculator:
    ...
    @staticmethod
    def _get_convex_hull_edges(points: List[Point]) -> List[Edge]:
    ...
    @staticmethod
    def _get_convex_hull_vertices(edges: List[Edge]) -> List[Point]:  # TODO: Check correctness
        e1 = edges[0]
